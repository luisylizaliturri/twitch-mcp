...
export let TWITCH_CLIENT_ID: string = '';
export let TWITCH_CLIENT_SECRET: string = '';

//Save user credentials for global use
export function initializeCredentials(clientId: string, clientSecret: string): void {
